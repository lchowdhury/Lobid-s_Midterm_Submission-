...
public class EmployeeInfo extends AllDepart implements Employee{
	 ...
	 */
	final static String companyName = "Syleht Drinking Water";
	int employeeId;
	String name;
	...
	public double calculateEmployeePension(){
		...
		System.out.println("Please enter start date in format (example: jan,2013): ");
